...
<script type="text/javascript">
	$(document).ready(function(){
		$.ajax({
			url:"${pageContext.request.contextPath}/goodsTypesServlet?method=goodsTypeList",
			type:"GET",
    	...
    	<div id="topdiv">
            ...
            <span style="float:right">
       			...
       			<c:if test="${not empty user}">
       				...
       				<li>|</li>
       				<a href="userServlet?method=loginOut" onclick="return confirm('确定要退出吗？')" id="a_top">注销</a>
       				<li>|</li>
