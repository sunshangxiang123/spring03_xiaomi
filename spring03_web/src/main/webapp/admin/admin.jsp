...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<ul id="top_right" class="collapse navbar-collapse nav navbar-nav navbar-right"	style="margin-right: 20px;">
			...
			<li>
				<a href="${pageContext.request.contextPath}/admin/userServlet?method=loginOut" onclick="return confirm('确定要退出吗？')">
		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/goodssServlet?method=getGoodsList");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/addGoodsServlet?method=goodsTypeList");
                    <%--${pageContext.request.contextPath}/addGoodsServlet?method=goodsTypeList--%>
				})
